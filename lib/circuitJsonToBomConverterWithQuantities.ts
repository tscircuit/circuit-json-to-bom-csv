...
export const convertCircuitJsonToBomRowsWithQuantities = async ({
  ...
  for (const elm of circuitJson) {
    ...
    const supplier_part_number_columns: Partial<BomRowWithQuantity["supplier_part_number_columns"]> = {};
...
export const convertBomRowsToCsvsWithQuantities = (bom_rows: BomRowWithQuantity[]): string => {
